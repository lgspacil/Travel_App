...
var HttpService = (function () {
    ...
    HttpService.prototype.getWeather = function (location) {
        return this._http.get("http://api.openweathermap.org/data/2.5/weather?q=" + location + "&units=imperial&APPID=bb928725dc4b57216334e06c6fbafa99").map(function (data) { return data.json(); }).toPromise();
    };
